   ...
   <section id="signup-form">
    ...
    <div class="signup-form">
        <form action="signup.php" method="POST">
            ...
            <div class="input-box">
                <input type="password" placeholder="Enter your password" name="password" required <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?> value="<?php echo $password; ?>"/>
                <span class="invalid-feedback"><?php echo $password_err; ?></span>
                <i class="uil uil-lock-alt password"></i>
                <i class="uil uil-eye-slash pw-hide"></i>
            </div>
            <div class="input-box">
                <input type="password" placeholder="Confirm your password" name="confirm_password" required <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?> value="<?php echo $confirm_password; ?>"/>
